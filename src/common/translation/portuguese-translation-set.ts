...
export const portugueseTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Limpar cachê",
    TapGoCommandClearCachesDescription: "Limpar todo cachê de todos os plugins",
    TapGoCommandEditSettingsFile: "Editar arquivo de configuração",
    TapGoCommandEditSettingsFileDescription: "Editar o arquivo de configuração com o editor padrão",
    TapGoCommandExit: "Fechar",
    TapGoCommandExitDescription: "Fechar o TapGo",
    TapGoCommandOpenSettings: "Configuração",
    TapGoCommandOpenSettingsDescription: "Alterar configurações",
    TapGoCommandRefreshIndexes: "Atualizar índices",
    TapGoCommandRefreshIndexesDescription: "Atualizar os índices de todos os plugins",
    TapGoCommandReload: "Recarregar",
    TapGoCommandReloadDescription: "Recarregar TapGo",
    TapGoCommandOpenDebugLogDescription: "Abrir o log de debug",
    TapGoCommandOpenDebugLog: "Log de debug",
