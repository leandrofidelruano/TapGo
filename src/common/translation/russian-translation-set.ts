...
export const russianTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Очистить кэш",
    TapGoCommandClearCachesDescription: "Очищает кэш всех плагинов",
    TapGoCommandEditSettingsFile: "Изменить файл настроек",
    TapGoCommandEditSettingsFileDescription: "Изменить файл настроек текстовым редактором по умолчанию",
    TapGoCommandExit: "Выйти",
    TapGoCommandExitDescription: "Выйти из TapGo",
    TapGoCommandOpenSettings: "Настройки",
    TapGoCommandOpenSettingsDescription: "Изменить настройки",
    TapGoCommandRefreshIndexes: "Обновить индексы",
    TapGoCommandRefreshIndexesDescription: "Обновить индексы всех плагинов",
    TapGoCommandReload: "Перезагрузить",
    TapGoCommandReloadDescription: "Перезагрузить TapGo",
    TapGoCommandOpenDebugLogDescription: "Открыть лог отладки",
    TapGoCommandOpenDebugLog: "Лог отладки",
    ...
    generalSettingsAutostartApp: "Запускать TapGo вместе с Windows",
