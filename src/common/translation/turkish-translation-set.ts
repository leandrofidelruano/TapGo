...
export const turkishTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Önbellekleri temizle",
    TapGoCommandClearCachesDescription: "Tüm eklentilerin tüm önbelleklerini temizler",
    TapGoCommandEditSettingsFile: "Ayarlar dosyasını düzenle",
    TapGoCommandEditSettingsFileDescription: "Ayarlar dosyasını varsayılan metin düzenleyicinizle düzenleyin",
    TapGoCommandExit: "Çıkış",
    TapGoCommandExitDescription: "TapGo uygulamasından çık",
    TapGoCommandOpenSettings: "Ayarlar",
    TapGoCommandOpenSettingsDescription: "Ayarları değiştir",
    TapGoCommandRefreshIndexes: "Dizinleri yenile",
    TapGoCommandRefreshIndexesDescription: "Tüm eklentilerin tüm dizinlerini yeniler",
    TapGoCommandReload: "Yeniden başlat",
    TapGoCommandReloadDescription: "TapGo'yi yeniden başlat",
    TapGoCommandOpenDebugLogDescription: "Hata ayıklama günlüğünü aç",
    TapGoCommandOpenDebugLog: "Hata ayıklama günlüğü",
