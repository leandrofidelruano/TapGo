...
export const koreanTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "캐시 초기화",
    TapGoCommandClearCachesDescription: "모든 플러그인의 모든 캐시를 초기화합니다.",
    TapGoCommandEditSettingsFile: "설정 파일 수정",
    TapGoCommandEditSettingsFileDescription: "기본 텍스트 편집기로 설정 파일을 수정할 수 있습니다.",
    TapGoCommandExit: "나가기",
    TapGoCommandExitDescription: "TapGo 앱을 나갑니다",
    TapGoCommandOpenSettings: "설정",
    TapGoCommandOpenSettingsDescription: "설정을 변경할 수 있습니다.",
    TapGoCommandRefreshIndexes: "인덱스 갱신",
    TapGoCommandRefreshIndexesDescription: "모든 플러그인의 모든 인덱스를 갱신합니다.",
    TapGoCommandReload: "다시 로드",
    TapGoCommandReloadDescription: "TapGo 다시 로드",
    TapGoCommandOpenDebugLogDescription: "디버그 로그 열기",
    TapGoCommandOpenDebugLog: "디버그 로그",
