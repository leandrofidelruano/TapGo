...
export const germanTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Caches löschen",
    TapGoCommandClearCachesDescription: "Löscht alle Zwischenspeicher von allen Plugins",
    TapGoCommandEditSettingsFile: "Einstellungsdatei bearbeiten",
    TapGoCommandEditSettingsFileDescription: "Bearbeite die Einstellungsdatei in deinem Standardtexteditor",
    TapGoCommandExit: "Beenden",
    TapGoCommandExitDescription: "TapGo beenden",
    TapGoCommandOpenSettings: "Einstellungen",
    TapGoCommandOpenSettingsDescription: "Einstellungen bearbeiten",
    TapGoCommandRefreshIndexes: "Indexe aktualisieren",
    TapGoCommandRefreshIndexesDescription: "Alle Indexe von allen Plugins aktualisieren",
    TapGoCommandReload: "Neu laden",
    TapGoCommandReloadDescription: "TapGo neu laden",
    TapGoCommandOpenDebugLogDescription: "Debug log öffnen",
    TapGoCommandOpenDebugLog: "Debug log",
