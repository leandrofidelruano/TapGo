...
export const spanishTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Borrar cachés",
    TapGoCommandClearCachesDescription: "Borrar todas las cachés de todos los plugins",
    TapGoCommandEditSettingsFile: "Editar archivo de configuración",
    TapGoCommandEditSettingsFileDescription: "Editar el archivo de configuración con tu editor de texto por defecto",
    TapGoCommandExit: "Salir",
    TapGoCommandExitDescription: "Salir de TapGo",
    TapGoCommandOpenSettings: "Configuración",
    TapGoCommandOpenSettingsDescription: "Cambiar configuración",
    TapGoCommandRefreshIndexes: "Refrescar índices",
    TapGoCommandRefreshIndexesDescription: "Refrescar todos los índices de todos los plugins",
    TapGoCommandReload: "Recargar",
    TapGoCommandReloadDescription: "Recargar TapGo",
    TapGoCommandOpenDebugLogDescription: "Abrir log de depuración",
    TapGoCommandOpenDebugLog: "Log de depuración",
    ...
    settingsPanelTitle: "Panel de configuración",
    ...
    colorThemeSettingsBackgroundColor: "Color de fondo del panel de configuración",
    colorThemeSettingsSidebarBackgroundColor: "Color de fondo del sidebar de configuración",
    colorThemeSettingsTextColor: "Color de texto del panel de configuración",
    colorThemeSettingsSidebarTextColor: "Color de texto del sidebar de configuración",
    colorThemeSettingsAccentColor: "Color de acento del panel de configuración",
    colorThemeSettingsBoxBackgroundColor: "Color de fondo de las cajas de configuración",
