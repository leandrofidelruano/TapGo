...
export const czechTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Vymazat mezipaměť",
    TapGoCommandClearCachesDescription: "Vymaže všechny mezipaměti všech pluginů",
    TapGoCommandEditSettingsFile: "Upravit soubor nastavení",
    TapGoCommandEditSettingsFileDescription: "Upravte soubor nastavení pomocí svého výchozího textového editoru",
    TapGoCommandExit: "Zavřít",
    TapGoCommandExitDescription: "Zavřít TapGo",
    TapGoCommandOpenSettings: "Nastavení",
    TapGoCommandOpenSettingsDescription: "Změnit nastavení",
    TapGoCommandRefreshIndexes: "Aktualizovat indexy",
    TapGoCommandRefreshIndexesDescription: "Aktualizuje všechny indexy všech pluginů",
    TapGoCommandReload: "Obnovit",
    TapGoCommandReloadDescription: "Obnovit TapGo",
    TapGoCommandOpenDebugLogDescription: "Otevřít záznamy pro ladění",
    TapGoCommandOpenDebugLog: "Záznamy pro ladění",
