...
export const englishTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Clear caches",
    TapGoCommandClearCachesDescription: "Clears all caches of all plugins",
    TapGoCommandEditSettingsFile: "Edit settings file",
    TapGoCommandEditSettingsFileDescription: "Edit the settings file with your default text editor",
    TapGoCommandExit: "Quit",
    TapGoCommandExitDescription: "Quit TapGo app",
    TapGoCommandOpenSettings: "Settings",
    TapGoCommandOpenSettingsDescription: "Change settings",
    TapGoCommandRefreshIndexes: "Refresh indexes",
    TapGoCommandRefreshIndexesDescription: "Refreshes all indexes of all plugins",
    TapGoCommandReload: "Reload",
    TapGoCommandReloadDescription: "Reload TapGo",
    TapGoCommandOpenDebugLogDescription: "Open debug log",
