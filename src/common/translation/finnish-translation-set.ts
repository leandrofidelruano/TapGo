...
export const finnishTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "Tyhjennä välimuisti",
    TapGoCommandClearCachesDescription: "Tyhjentää kaikkien lisäosien välimuistit",
    TapGoCommandEditSettingsFile: "Muokkaa asetustiedostoa",
    TapGoCommandEditSettingsFileDescription: "Muokkaa asetustiedostoa oletustekstieditorilla",
    TapGoCommandExit: "Lopeta",
    TapGoCommandExitDescription: "Poistu TapGo sovelluksesta",
    TapGoCommandOpenSettings: "Asetukset",
    TapGoCommandOpenSettingsDescription: "Muokkaa asetuksia",
    TapGoCommandRefreshIndexes: "Päivitä indeksit",
    TapGoCommandRefreshIndexesDescription: "Päivittää kaikkien lisäosien indeksit",
    TapGoCommandReload: "Lataa uudelleen",
    TapGoCommandReloadDescription: "Lataa TapGo uudelleen",
    TapGoCommandOpenDebugLogDescription: "Avaa vianmääritysloki",
    TapGoCommandOpenDebugLog: "vianmääritysloki",
