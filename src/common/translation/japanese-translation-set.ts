...
export const japaneseTranslationSet: TranslationSet = {
    ...
    TapGoCommandClearCaches: "キャッシュの消去",
    TapGoCommandClearCachesDescription: "全てのプラグインのキャッシュを消去",
    TapGoCommandEditSettingsFile: "設定ファイルの編集",
    TapGoCommandEditSettingsFileDescription: "デフォルトのテキストエディタで設定ファイルを編集",
    TapGoCommandExit: "終了",
    TapGoCommandExitDescription: "TapGo アプリケーションを終了",
    TapGoCommandOpenSettings: "設定",
    TapGoCommandOpenSettingsDescription: "設定の変更",
    TapGoCommandRefreshIndexes: "インデックスの再作成",
    TapGoCommandRefreshIndexesDescription: "全てのプラグインのインデックスを再作成",
    TapGoCommandReload: "再読み込み",
    TapGoCommandReloadDescription: "TapGo の再読み込み",
    TapGoCommandOpenDebugLogDescription: "デバッグログを開く",
    TapGoCommandOpenDebugLog: "デバッグログ",
