...
TapGo is a keystroke launcher for Windows and macOS.
...
-   [License](#license)
-   [Release notes](https://github.com/leandrofidelruano/tapgo/releases)

## Installation

### Installer / Zip

-   Download the latest version from here: https://github.com/leandrofidelruano/tapgo/releases
...
This plugin searches for applications on your computer. You can specify the folders where your applications are installed and which file extension should be used to recognize an application.
...
2. Specify the file path to `es.exe` in TapGo's settings.
...
| <kbd>Ctrl</kbd> <kbd>o</kbd>        | Open the selected program or file at its location (Windows)  |
| <kbd>Cmd</kbd> <kbd>o</kbd>         | Open the selected program or file at its location (macOS)    |
| <kbd>↑</kbd>                        | Scroll up                                                    |
| <kbd>↓</kbd>                        | Scroll down                                                  |
...
> This list reflects the languages TapGo currently supports. Update it as you add more translations.
...
To check if any updates are available, open the settings. Under "General Settings" you can check if an update is available or not.
...
For better search results, TapGo keeps track of the applications, files and folders you execute. If you don't want TapGo to track your executions, simply open the settings and click on the "three-dot" menu on the top right, choose "Clear execution log", and disable the option "Log execution".

## Known bugs

For known issues, check [here](https://github.com/leandrofidelruano/tapgo/issues).
